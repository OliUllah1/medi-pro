...
const Facility = () => {
    ...
    return (
        <div className="bg-slate-100 grid grid-cols-1 gap-y-5 lg:grid-cols-3 px-3 lg:px-10 py-10 lg:py-20">
            <div data-aos="fade-right" className="relative h-full bg-[#f7a582]">
            ...
            <div data-aos="fade-up" className="p-10 space-y-3 bg-[#07332f] border-r border-white">
            ...
            <div data-aos="fade-left" className="p-10 space-y-3 bg-[#07332f]">
