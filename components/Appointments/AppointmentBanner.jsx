    ...
    return (
        <div className='bg-[#07332f] relative flex justify-center items-center py-20'>
            <div>
                ...
                <h1 className="text-[#f7a582] font-semibold text-5xl mb-5">Appointment Booking</h1>
                <p className="flex items-center gap-5 justify-center font-semibold text-white text-xl">Home <FaAngleDoubleRight className="text-[#f7a582]" /> Appointment Booking</p>
            </div>
